...
class RookTest {
    ...
    void testRookMovesStraight() {
        Rook rook = new Rook(1, board.getSquare(3, 3), "wrook.png");
    ...
    void testRookBlockedBySameColorPiece() {
        Rook rook = new Rook(1, board.getSquare(3, 3), "wrook.png");
        Piece blocker = new Rook(1, board.getSquare(3, 5), "wrook.png");
    ...
    void testRookCapturesOpponent() {
        Rook rook = new Rook(1, board.getSquare(3, 3), "wrook.png");
        Piece enemy = new Rook(0, board.getSquare(3, 5), "brook.png");
