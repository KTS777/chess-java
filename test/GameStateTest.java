...
public class GameStateTest {
    ...
    public void setup() {
        ...
        whiteKing = new King(1, squares[7][4], "wking.png");
        blackKing = new King(0, squares[0][4], "bking.png");
    ...
    public void testWhiteCheckBlack() {
        Rook rook = new Rook(1, squares[1][4], "wrook.png");
    ...
    public void testCheckmateCondition() {
        Rook rook1 = new Rook(1, squares[1][3], "wrook.png");
        Rook rook2 = new Rook(1, squares[1][5], "wrook.png");
    ...
    public void testStalemateCondition() {
        ...
        Pawn whitePawn = new Pawn(1, squares[1][1], "wp.png");
